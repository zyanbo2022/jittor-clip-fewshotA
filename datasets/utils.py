...
class DatasetWrapper(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #     img0 = img0
        # if item.domain == 2:# 灰度
        #     random_gray = jt_transform.RandomGray(1.0)
        #     img0 = random_gray(img0)
        # if item.domain == 3:# 逆时针旋转45度
        #     random_affine = jt_transform.RandomAffine(degrees=45)
        #     img0 = random_affine(img0)
        # if item.domain == 4: #降低对比度
        #     random_affine = jt_transform.RandomAffine(degrees=20)
        #     img0 = random_affine(img0)
